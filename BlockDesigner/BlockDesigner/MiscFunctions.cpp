...
// get convex hull of a set of n points. (https://www.geeksforgeeks.org/convex-hull-using-graham-scan/)
void ConvexHull(glm::vec2 points[], int n, std::vector<glm::vec2>& outHull)
{
